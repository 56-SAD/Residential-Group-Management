...
public class NhanKhau_ThongTin extends JDialog {
	...
	NhanKhau_ThongTin_Panel panel = new NhanKhau_ThongTin_Panel();

	/**
	 * Create the dialog.
	 */
	public NhanKhau_ThongTin() {
		 ...
		 * */
			...
			InputField txtQuanHe = new InputField("Số Hộ khẩu");
			txtQuanHe.setEditable(false);
			txtQuanHe.setLabel("Quan he voi chu ho");
			txtQuanHe.setText("Chu ho");
			txtQuanHe.setFont(new Font("Tahoma", Font.PLAIN, 12));
			...
			InputField txtGhiChu = new InputField("Số Hộ khẩu");
